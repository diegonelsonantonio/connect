      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a routerLink="/home" class="text-gray-400 hover:text-white transition-colors duration-200">Home</a></li>
              <li><a routerLink="/upload" class="text-gray-400 hover:text-white transition-colors duration-200">Upload</a></li>
              <li><a routerLink="/profile" class="text-gray-400 hover:text-white transition-colors duration-200">Profile</a></li>
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Help</a></li>
            </ul>
          </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center">
          <p class="text-gray-400">
            © 2024 Connect. All rights reserved. Made with ❤️ for connecting people.
          </p>
        </div>
      </div>
    </footer>
